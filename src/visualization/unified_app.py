        ...
        return [
            {
                ...
                'created_at': project.configuration.created_at.isoformat() if project.configuration.created_at else None,
...
class SimulationConfiguration:
    ...
    def __init__(self, data: Dict[str, Any] = None):
        ...
        self.buildings = data.get('buildings', {
            "residential": 10, "commercial": 5, "industrial": 3,
            "casinos": 2, "liquor_stores": 5
        })
        
        # Population configuration
        self.total_agents = data.get('total_agents', 100)
        self.population_mix = data.get('population_mix', {
            "balanced": 0.7, "vulnerable": 0.3
        })
        self.behavioral_params = data.get('behavioral_params', {
        ...
        self.economic_conditions = data.get('economic_conditions', {
        ...
        self.data_collection = data.get('data_collection', {
            "agent_metrics": True,
...
class Project:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Project':
        ...
        project.results_path = Path(data['results_path']) if data.get('results_path') else None
        return project
...
class SimulationManager:
    ...
    def export_data(self, simulation_id: str, export_type: str, options: Dict[str, Any]) -> Path:
        """Export simulation data."""
        export_path = self.simulation_bridge.export_simulation_data(simulation_id, export_type, options)
