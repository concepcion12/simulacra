...
from simulacra.agents import Agent, Action, ActionContext, generate_available_actions, MovementSystem
...
from simulacra.environment.buildings.casino import Casino
from simulacra.environment.buildings.employer import Employer
from simulacra.environment.buildings.public_space import PublicSpace
from simulacra.environment.buildings.residential import ResidentialBuilding
...
def create_demo_city() -> City:
    ...
    from simulacra.environment.buildings.employer import JobOpening
    job = JobOpening(
        job_id="job_tech_1",
    ...
    from simulacra.environment.buildings.casino import GamblingGame
    slots = GamblingGame(
        name="Slot Machine",
        min_bet=5.0,
        max_bet=100.0,
    ...
    for i in range(3):
        ...
        from simulacra.environment.buildings.residential import HousingUnit
        units = []
