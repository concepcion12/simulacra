...
from simulacra.agents.action_outcomes import OutcomeContext
from simulacra.utils.types import ActionType
...
if __name__ == "__main__":
    # Run all demos
    from simulacra.utils.types import BehaviorType, SubstanceType
